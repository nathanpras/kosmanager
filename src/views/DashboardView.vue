...
<template>
  <!-- Satu root node, wajib. `<RouterView class="content" />` di App.vue
       menitipkan kelas .content lewat fallthrough attrs, dan Vue membuangnya
       diam-diam begitu komponennya punya lebih dari satu root — dulu tiga:
       cabang v-if, cabang v-else, dan dialognya. Akibatnya khusus Dashboard
       tidak kebagian padding .content sama sekali, sehingga isinya menempel
       ke topbar dan ke sidebar. -->
  <div>
